...
```
wget -qO- https://cdn.jsdelivr.net/gh/wy2919/shell-all/vps-v2-warp/deji/warp4.sh|bash
```
#### 脚本2：IPV4与IPV6都是WARP分配的IP
```
wget -qO- https://cdn.jsdelivr.net/gh/wy2919/shell-all/vps-v2-warp/deji/warp64.sh|bash
```
----------------------------------------------------------------------------------------------------
